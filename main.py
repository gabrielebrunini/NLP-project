...
from data_loader import load_and_cache_examples, SemEvalDataset
...
def main(args):
    ...
    train_dataset = SemEvalDataset(os.path.join(args.data_dir,args.train_file), tokenizer, args, mode="train")
    test_dataset = SemEvalDataset(os.path.join(args.data_dir,args.test_file), tokenizer, args, mode="test")
